...
UI helpers currently use plus checks in ChatInput.tsx:138 and ChatToolControls.tsx:50. Runtime/context logic also depends on plus checks in contextProcessor.ts:252. If someone “just adds Telegram to isAgentChain” in utils.ts:411, Telegram UI controls may unintentionally surface. The plan should explicitly require a new runtime policy helper and keep utils.ts:411 UI-facing only.
